 ...
 * @date 2016/10/12
 *
 * Header file for module ATu0v11.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(ATu0v11_RECURSES)
#error Recursive header files inclusion detected in ATu0v11.h
#else // defined(ATu0v11_RECURSES)
/** Prevents recursive inclusion of headers. */
#define ATu0v11_RECURSES

#if !defined ATu0v11_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // template class ATu0v11
  /**
  * Description of template class 'ATu0v11' <p> \brief Aim: This class
  ...
  */
  ...
  struct ATu0v11 : public DECImage2D<TKSpace, TLinearAlgebra>
  {
  ...
  public:
    ...
    */
     ...
     */
    ATu0v11 ( const ATu0v11 & other ) = delete;

    /**
     * Move constructor.
     * @param other the object to move.
     */
    ATu0v11 ( ATu0v11 && other ) = delete;
     ...
     */
    ATu0v11 & operator= ( const ATu0v11 & other ) = delete;
     ...
     * @return a reference on 'this'.
     */
    ATu0v11 & operator= ( ATu0v11 && other ) = delete;
  ...
  }; // end of class ATu0v11


  /**
   * Overloads 'operator<<' for displaying objects of class 'ATu0v11'.
   * @param out the output stream where the object is written.
   * @param object the object of class 'ATu0v11' to write.
   * @return the output stream after the writing.
   */
  template <typename TKSpace, typename TLinearAlgebra>
  std::ostream&
  operator<< ( std::ostream & out, const ATu0v11<TKSpace, TLinearAlgebra> & object );
...
//#include "DGtal/dec/ATu0v11.ih"
#include "ATu0v11.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined ATu0v11_h

#undef ATu0v11_RECURSES
#endif // else defined(ATu0v11_RECURSES)
