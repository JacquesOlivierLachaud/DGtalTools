 ...
 * @date 2016/10/12
 *
 * Header file for module ATu2v00.cpp
 *
 * This file is part of the DGtal library.
 */

#if defined(ATu2v00_RECURSES)
#error Recursive header files inclusion detected in ATu2v00.h
#else // defined(ATu2v00_RECURSES)
/** Prevents recursive inclusion of headers. */
#define ATu2v00_RECURSES

#if !defined ATu2v00_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // template class ATu2v00
  /**
  * Description of template class 'ATu2v00' <p> \brief Aim: This class
  ...
  */
  ...
  struct ATu2v00 : public DECImage2D<TKSpace, TLinearAlgebra>
  {
  ...
  public:
    ...
    */
     ...
     */
    ATu2v00 ( const ATu2v00 & other ) = delete;

    /**
     * Move constructor.
     * @param other the object to move.
     */
    ATu2v00 ( ATu2v00 && other ) = delete;
     ...
     */
    ATu2v00 & operator= ( const ATu2v00 & other ) = delete;
     ...
     * @return a reference on 'this'.
     */
    ATu2v00 & operator= ( ATu2v00 && other ) = delete;
  ...
  }; // end of class ATu2v00


  /**
   * Overloads 'operator<<' for displaying objects of class 'ATu2v00'.
   * @param out the output stream where the object is written.
   * @param object the object of class 'ATu2v00' to write.
   * @return the output stream after the writing.
   */
  template <typename TKSpace, typename TLinearAlgebra>
  std::ostream&
  operator<< ( std::ostream & out, const ATu2v00<TKSpace, TLinearAlgebra> & object );
...
//#include "DGtal/dec/ATu2v00.ih"
#include "ATu2v00.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined ATu2v00_h

#undef ATu2v00_RECURSES
#endif // else defined(ATu2v00_RECURSES)
